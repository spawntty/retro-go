...
{RG_KEY_LEFT,   GPIO_NUM_8,  GPIO_PULLUP_ONLY, 0},\
{RG_KEY_RIGHT,  GPIO_NUM_17, GPIO_PULLUP_ONLY, 0},\
...
{RG_KEY_A,      GPIO_NUM_5,  GPIO_PULLUP_ONLY, 0},\
{RG_KEY_B,      GPIO_NUM_6,  GPIO_PULLUP_ONLY, 0},\
{RG_KEY_X,      GPIO_NUM_7,  GPIO_PULLUP_ONLY, 0},\
{RG_KEY_Y,      GPIO_NUM_15, GPIO_PULLUP_ONLY, 0},\
{RG_KEY_L,      GPIO_NUM_48, GPIO_PULLUP_ONLY, 0},\
{RG_KEY_R,      GPIO_NUM_2,  GPIO_PULLUP_ONLY, 0},\
}
